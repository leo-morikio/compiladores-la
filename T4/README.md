# T4 - Analisador Semântico Avançado (Linguagem LA)

Este projeto consiste na implementação do **Analisador Semântico do Trabalho 4** para a Linguagem Algorítmica (LA), com verificações adicionais de ponteiros, registros, chamadas de sub-rotinas e uso de `retorne`.
